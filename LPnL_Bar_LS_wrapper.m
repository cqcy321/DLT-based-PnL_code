function [ R, T ] = LPnL_Bar_LS_wrapper( X_W, x_c )
%LPNL_BAR_LS_WRAPPER Camera pose estimation from line correspondences based on
...
%   The 3D camera coordinate system is right-handed: X-right, Y-up, Z-back.
	...
	%% Call LPnL_Bar_LS
	[R_LS, T_LS] = LPnL_Bar_LS(x1_c(1:2,:), x2_c(1:2,:), X1_W(1:3,:), X2_W(1:3,:));
