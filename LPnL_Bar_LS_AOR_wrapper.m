function [ R, T ] = LPnL_Bar_LS_AOR_wrapper( X_W, x_c )
%LPNL_BAR_LS_AOR_WRAPPER Camera pose estimation from line correspondences using
% the LPnL_Bar_LS method with Algebraic Outlier Rejection module.
%
...
%   The 3D camera coordinate system is right-handed: X-right, Y-up, Z-back.
	...
	%% Call LPnL_Bar_LS with AOR
	[R_LS, T_LS] = RLPnL_LS(x1_c(1:2,:), x2_c(1:2,:), X1_W(1:3,:), X2_W(1:3,:));
