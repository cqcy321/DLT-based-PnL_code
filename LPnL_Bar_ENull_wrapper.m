function [ R, T ] = LPnL_Bar_ENull_wrapper( X_W, x_c )
%LPNL_BAR_ENULL_WRAPPER Camera pose estimation from line correspondences based on
...
%   The 3D camera coordinate system is right-handed: X-right, Y-up, Z-back.
	...
	%% Call LPnL_Bar_ENull
	[R_ENull, T_ENull] = LPnL_Bar_ENull(x1_c(1:2,:), x2_c(1:2,:), X1_W(1:3,:), X2_W(1:3,:));
