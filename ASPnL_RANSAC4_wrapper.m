function [ R, T ] = ASPnL_RANSAC4_wrapper( X_W, x_c )
%ASPNL_RANSAC4_WRAPPER Camera pose estimation from line correspondences using
% the ASPnL method plugged into a RANSAC loop.
%
...
%   The 3D camera coordinate system is right-handed: X-right, Y-up, Z-back.
	...
	%% Call ASPnL + RANSAC
	[R_ASPnL, T_ASPnL] = RANSAC4(x1_c(1:2,:), x2_c(1:2,:), X1_W(1:3,:), X2_W(1:3,:));
