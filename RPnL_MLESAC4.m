function [ R, T ] = RPnL_MLESAC4( X_W, x_c, probab, max_iter, Ep_th)
%RPNL_MLESAC4 Camera pose estimation from line correspondences using
% the RPnL method plugged into a MLESAC loop.
%
...
%   The 3D camera coordinate system is right-handed: X-right, Y-up, Z-back.
	...
	is_inlier = MLESAC(X_W, x_c, @RPnL_wrapper, MIN_LINES, probab, max_iter, Ep_th);
