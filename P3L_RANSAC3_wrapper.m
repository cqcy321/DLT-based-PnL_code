function [ R, T ] = P3L_RANSAC3_wrapper( X_W, x_c )
%P3L_RANSAC3_WRAPPER Camera pose estimation from line correspondences using
% the P3L method plugged into a RANSAC loop.
%
...
%   The 3D camera coordinate system is right-handed: X-right, Y-up, Z-back.
	...
	%% Call P3L + RANSAC
	[R_P3L, T_P3L] = RANSAC3(x1_c(1:2,:), x2_c(1:2,:), X1_W(1:3,:), X2_W(1:3,:));
